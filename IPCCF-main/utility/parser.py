...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='', help='Choose a dataset from {gowalla, amazon, tmall}')
    ...
    parser.add_argument('--cen_reg', type=float, default=1e-5, help='Regularizations.')
    parser.add_argument('--cen_dis', type=float, default=5e-3, help='The distance between intentions.')
    ...
    parser.add_argument('--n_intents', type=int, default=8, help='Number of latent intents')
    ...
    parser.add_argument('--ui_k', type=int, default=5, help='Number of high order neighbors.')
    parser.add_argument('--early_stop', type=int, default=50, help='Number of early stop epochs.')
